      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="p-6 sm:p-10">
            <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white mb-8">API Playground</h1>
            <div className="grid gap-12 lg:grid-cols-2">
              <div className="space-y-8">
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-inner">
                  <Label htmlFor="api-key" className="text-lg font-semibold mb-2 block">API Key</Label>
                ...
                <div className="space-y-4">
                  <Label className="text-lg font-semibold">Invoice Details</Label>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button onClick={generateInvoice} disabled={loading} className="w-full sm:w-auto">
                    {loading ? (
                ...
                {generatedInvoiceNumber && (
                  <div className="mt-4 p-4 bg-green-100 dark:bg-green-900 border border-green-300 dark:border-green-700 rounded-md">
                    <p className="text-green-800 dark:text-green-200">Generated Invoice Number: {generatedInvoiceNumber}</p>
                  </div>
                )}
              </div>
              <div className="space-y-8">
                <Tabs defaultValue="preview" className="w-full">
                  ...
                  <TabsContent value="preview">
                    <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-6 shadow-inner">
                      <Label className="text-lg font-semibold mb-2 block">Preview</Label>
                     <SyntaxHighlighter language="json" style={tomorrow} customStyle={{
                        backgroundColor: 'transparent',
                        padding: '0',
                        margin: '0',
                        fontSize: '0.875rem',
                        fontWeight: 700, // Added this line for bolder text
                      }}>
                  ...
                  <TabsContent value="request">
                    <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-6 shadow-inner">
                      <Label className="text-lg font-semibold mb-2 block">API Request</Label>
